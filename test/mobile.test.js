...
test('the version is set and shown',()=>{
 ...
 assert.ok(read('index.html').includes('<span id="version"></span>')&&read('index.html').includes('href="https://github.com/Piyushrathoree/dark-soul"'),'the pause band foot carries the version and the source link');
});
